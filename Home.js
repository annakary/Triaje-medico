...
const Home = () => {
  ...
  return (
    <View style={tw`flex-1 items-center justify-center relative`}>
      <View style={tw`bg-[#102536] w-full top-0 absolute z-20`}>
      ...
      <ScrollView>
        <TouchableOpacity onPress={handleEmergencyDicharge}>
          <View style={tw`w-full bg-gray-200	top-20 px-15 py-7  items-center rounded-xl`}>
            <Image style={tw` `} source={require('./assets/icono-urgencia.png')} />
            <Text style={tw`text-gray mt-5 text-3xl tracking-widest`}>Alta de Urgencia</Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity onPress={handleDischargePatient}>
        <View style={tw`w-full bg-gray-200 mt-10	top-20 px-15 py-7  items-center rounded-xl`}>
          <Image style={tw` `} source={require('./assets/icono-alta-paciente.png')} />
          <Text style={tw`text-gray mt-5 text-3xl tracking-widest`}>Alta de Paciente</Text>
        </View>
        </TouchableOpacity>
        ...
        <View style={tw`w-full bg-gray-200 mt-10	top-20 px-15 py-7  items-center rounded-xl`}>
          ...
          <Text style={tw`text-gray mt-5 text-3xl tracking-widest`}>Lista de Pacientes</Text>
        </View>
        </TouchableOpacity>
        ...
        <View style={tw`w-full bg-gray-200 mt-10	top-20 px-15 py-7  items-center rounded-xl`}>
          ...
          <Text style={tw`text-gray mt-5 text-3xl tracking-widest`}>Información</Text>
        </View>
        </TouchableOpacity>
